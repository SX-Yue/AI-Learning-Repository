...
REM Run the agent in another directory
 "D:\projects\AI-Learning-Repository\deepseek_api_test\git_available_agent_English_ver_context\.venv\Scripts\python.exe" ^
 "D:\projects\AI-Learning-Repository\deepseek_api_test\git_available_agent_English_ver_context\main_agent.py"